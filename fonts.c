...
bool loadMedia(CL_Instance* instance)
{
    ...
    } else
    {
        ...
        if (!instance->gTextTexture->loadFromRenderedText(instance->gTextTexture, instance, "Hirwa is the best programmer up to death!", textColor) )
        {
...
int main()
{
    ...
    lTexture_s texture;
    instance.gTextTexture = &texture;
    instance.gTextTexture->loadFromFile = &loadFromFile;
    instance.gTextTexture->render = &render;
    instance.gTextTexture->setAlpha = &setAlpha;
    instance.gTextTexture->setBlendMode = &setBlendMode;
    instance.gTextTexture->loadFromRenderedText = &loadFromRenderedText;
    ...
    } else
    {
        ...
        } else
        {
            ...
            while(!quit)
            {
                ...
                instance.gTextTexture->render(instance.gTextTexture, &instance, (SCREEN_WIDTH - instance.gTextTexture->mWidth) / 2, (SCREEN_HEIGHT - instance.gTextTexture->mHeight) / 2, NULL, 0, NULL, flipType);
